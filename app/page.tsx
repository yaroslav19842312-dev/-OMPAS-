...
function ResultView({result,restart}:{result:Result;restart:()=>void}){
 ...
 <div className="resultActions"><a className="goldBtn mapBtn actionLink" href="/docs/kompas-professions-varna-checklist.pdf" target="_blank" rel="noopener noreferrer">ИССЛЕДОВАТЬ ПРОФЕССИИ <span>→</span></a><button className="ghostBtn" onClick={restart}>Пройти ещё раз</button></div>
